...
//-------------- pas besoin
 ...
 render (
   <Provider store={store}>
     <TodoApp />
     {/* <Router history={hashHistory}>       ca fonctionne aussi avec le router
...
//video 62- 84
 ...
 //APP TIMER  !!! IMPORTANT IMPORTANT REMMETRE EN VIE ET L APP REVIENT
//
...
//=================================================================================================================================
   //video 26 - 61 Routing pour plusieurs pages

   //on aura un main, nav et page component

   //APP WEATHER  !!! IMPORTANT IMPORTANT REMMETRE EN VIE ET L APP REVIENT

   // import Main  from './components/weather/main'
   // import Weather from './components/weather/Weather'
   // import About from './components/weather/About'
   // import Examples from './components/weather/Examples'
   // import { Perdu } from './components/weather/Whoops404'
   //
   //
   // render (
