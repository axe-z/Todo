...
// let TodoAPI = require('../api/TodoAPI'); en a pu besoin avec redux

const TodoApp = React.createClass({
  // getInitialState(){                                               // tout le state est gere par le store
  //   return {
  ...
  //   }
  // },
  // componentDidUpdate(){                                            //redux s 'occupe  d'envoyer le data
  ...
  // handleAddTodo(text){  //passe par addtodo                       // c;est les actions qui font ca maintenant
  //   this.setState({
  //     todos: [
  //       ...this.state.todos,
  //       {
  ...
  //  })
  // },
  // handleSearch(showCompleted,searchText){ ///passe par search               //search et une action redux.
  //
  //   this.setState({
  ...
  // },
  render() {
      // let { todos, showCompleted, searchText, completedAt } = this.state            //redux stuff
      // let filteredTodos = TodoAPI.filterTodos(todos, showCompleted, searchText);    //redux stuff
    return (
